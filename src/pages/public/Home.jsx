...
const categoryTiles = [
  { name: "Paints", bg: "#EDE7F6", img: "https://loremflickr.com/500/500/paint,bucket" },
  { name: "Electronics", bg: "#F1F5F9", img: "https://loremflickr.com/500/500/refrigerator,appliance" },
  { name: "Furniture", bg: "#E3F2FD", img: "https://loremflickr.com/500/500/sofa,furniture" },
  { name: "Hardware", bg: "#FFF3E0", img: "https://loremflickr.com/500/500/drill,tools" },
  { name: "Plumbing", bg: "#EFF6FF", img: "https://loremflickr.com/500/500/faucet,tap" },
];
const brands = [
  { name: "Asian Paints", color: "#F4EDE4", short: "AP", dark: true },
  { name: "Somany", color: "#D92B2B", short: "SOMANY" },
  { name: "Johnson", color: "#FFFFFF", short: "JOHNSON", dark: true },
  { name: "Cera", color: "#FFFFFF", short: "CERA", dark: true },
  { name: "Kajaria", color: "#153E7E", short: "KAJARIA" },
  { name: "Berger Paints", color: "#0EA5E9", short: "BERGER" },
  { name: "Havells", color: "#FFFFFF", short: "HAVELLS", dark: true },
  { name: "Godrej", color: "#16A34A", short: "GODREJ" },
  { name: "Bosch", color: "#DC2626", short: "BOSCH" },
];

const categories = [
  { name: "Cement", img: "https://loremflickr.com/200/200/cement,bag", tag: "Bulk Prices" },
  { name: "Tiling", img: "https://loremflickr.com/200/200/tiles,ceramic", tag: "Bulk Prices" },
  { name: "Painting", img: "https://loremflickr.com/200/200/paint,bucket" },
  { name: "Water Proofing", img: "https://loremflickr.com/200/200/waterproofing,construction" },
  { name: "Plywood, MDF & HDHMR", img: "https://loremflickr.com/200/200/plywood,wood" },
  { name: "Adhesives", img: "https://loremflickr.com/200/200/adhesive,glue" },
  { name: "Wires, MCB & Boards", img: "https://loremflickr.com/200/200/electrical,wires" },
  { name: "Kitchen Sinks & Faucets", img: "https://loremflickr.com/200/200/kitchen,sink" },
  { name: "Sanitary & Bath Fittings", img: "https://loremflickr.com/200/200/bathroom,fittings" },
  { name: "Switches & Sockets", img: "https://loremflickr.com/200/200/switch,socket" },
  { name: "Hardware & Handles", img: "https://loremflickr.com/200/200/door,hinges" },
  { name: "Lighting", img: "https://loremflickr.com/200/200/led,light" },
];
...
const banners = [
  {
    ...
    img: "https://loremflickr.com/400/400/bathroom,interior",
  },
  {
    tag: "NEW ARRIVALS",
    title: ["Modern Furniture.", "Timeless Design.", "Shop the Collection."],
    img: "https://loremflickr.com/400/400/furniture,modern",
  },
  {
    tag: "LIMITED TIME",
    title: ["Power Tools.", "Trusted Brands.", "Up to 30% Off."],
    img: "https://loremflickr.com/400/400/tools,hardware",
  },
];
...
const deals = [
  {
    ...
    brand: "Priya",
    img: "https://loremflickr.com/200/200/cement,bag",
    mrp: 360,
    price: 350,
    discount: "3% OFF",
  ...
  {
    id: "deal-2",
    name: "SmartCare Damp Sheath Interior Waterproofing Primer, 20L",
    brand: "SmartCare",
    img: "https://loremflickr.com/200/200/paint,primer",
    mrp: 3250,
    price: 3250,
    discount: null,
    cashback: "₹1000 Cashback",
  ...
  {
    id: "deal-3",
    name: "P-Sand (Plastering Sand), Triple Washed, 25kg Bag",
    brand: "Generic",
    img: "https://loremflickr.com/200/200/sand,bag",
    mrp: 150,
    price: 150,
    discount: null,
    cashback: "₹1000 Cashback",
  },
  {
    ...
    brand: "Tractor",
    img: "https://loremflickr.com/200/200/paint,bucket,white",
    mrp: 1580,
    price: 980,
    discount: "38% OFF",
    cashback: "₹1000 Cashback",
  ...
  {
    id: "deal-5",
    name: "General Purpose Sealant, White",
    brand: "Generic",
    img: "https://loremflickr.com/200/200/sealant,tube",
    mrp: 450,
    price: 141,
    discount: "69% OFF",
    cashback: "₹1000 Cashback",
        ...
        <section>
          ...
          <div className="flex gap-5 overflow-x-auto pb-1 -mx-1 px-1">
            {brands.map((b) => (
              ...
              >
                <div
                  className="w-16 h-16 rounded-full border border-slate-200 flex items-center justify-center text-[9px] font-bold text-center px-1 leading-tight hover:border-brand-500 transition-colors"
                  style={{ backgroundColor: b.color, color: b.dark ? "#0f172a" : "#fff" }}
                >
                  {b.short}
                </div>
